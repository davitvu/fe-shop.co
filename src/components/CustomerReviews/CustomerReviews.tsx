                        ...
                        <Slider>
                            {data.map((item: ReviewCard) => (
                                <>
                                    ...
                                    <div className="hidden sm:block pointer-events-none absolute left-0 top-0 h-full w-[130px] 
                          bg-gradient-to-r from-white to-transparent"></div>

                                    <div className="hidden sm:block pointer-events-none absolute right-0 top-0 h-full w-[130px] 
