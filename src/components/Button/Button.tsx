...
export function Button({
  ...
  const buttonClass = cn(
    ...
    variant === "outline" && "bg-white text-black border border-black hover:bg-[#ccc]",
    className
  );
