                ...
                <div className="w-full pt-10 lg:p-0 lg:h-[80vh] lg:shrink-0 flex flex-col lg:flex-row lg:justify-between">
                    <div className="lg:w-1/2 my-auto">
                        ...
                        <div className="flex flex-wrap gap-10 justify-center lg:text-left text-center">
                            ...
                            <div className="sm:border-l md:border-r px-10">
                    ...
                    <div className="relative pt-10 lg:p-0 lg:w-1/2">
                        <svg className="absolute top-60 left-0" width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className="absolute top-20 right-0" width="104" height="104" viewBox="0 0 104 104" fill="none" xmlns="http://www.w3.org/2000/svg">
